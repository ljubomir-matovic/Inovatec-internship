...
@Component({
  selector: 'app-equipment-assigned',
  templateUrl: './equipment-assigned.component.html',
  styleUrls: ['./equipment-assigned.component.scss']
})
export class EquipmentAssignedComponent implements OnInit{
  equipments!: any[];
  ...
  set selectedUserId(value:number | null) {
    this.equipmentService.selectedUserId = value;
  }
  ...
  userChanged(value:number | null): void {
    this.loadEquipment(this.lastLoadEvent);
  }
}
